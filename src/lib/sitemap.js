...
export async function generateSitemap() {
  ...
  const staticUrls = `
    ...
    <url><loc>${baseUrl}/how-it-works</loc>
     <lastmod>${currentDate}</lastmod></url>
    <url><loc>${baseUrl}/listing/1-bhk-rent-house-in-gurgaon</loc>
     <lastmod>${currentDate}</lastmod></url>
    <url><loc>${baseUrl}/listing/2-bhk-rent-house-in-gurgaon</loc>
     <lastmod>${currentDate}</lastmod></url>
    <url><loc>${baseUrl}/listing/3-bhk-rent-house-in-gurgaon</loc>
     <lastmod>${currentDate}</lastmod></url>
    <url><loc>${baseUrl}/listing/4-bhk-rent-house-in-gurgaon</loc>
     <lastmod>${currentDate}</lastmod></url>

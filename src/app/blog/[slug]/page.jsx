...
async function getBlogData(slug) {
  ...
  try {
    ...
    const res = await fetch(
      `https://gurgaon-backend.onrender.com/blogs/getBlogBySlug/${slug}?domain=www.renthouseingurgaon.com`,
      {
         cache: "force-cache",
...
export async function generateMetadata({ params }) {
  ...
  if (!single) {
    return {
      title: "Rent House – Blog",
      description: "Explore the latest blogs and articles on Rent House.",
    };
  }

  return {
    title: single?.MetaTitle || single?.Title || " Rent House Blog",
    description:

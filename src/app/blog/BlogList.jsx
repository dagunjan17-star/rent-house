      ...
      {loading && (
        <div className="flex justify-center items-center py-24">
          <div className="relative flex items-center justify-center">
            ...
            bg-[#78C841]/20 blur-xl animate-pulse"></div>

            {/* RING */}
            <div className="w-16 h-16 rounded-full border-[5px] border-[#78C841]/10"></div>

            {/* SPINNER */}
            <div className="absolute w-16 h-16 rounded-full 
            border-[5px] border-transparent 
            border-t-[#78C841] border-r-[#5fae2e] 
            animate-spin"></div>

            {/* CENTER DOT */}
            <div className="absolute w-3 h-3 bg-[#78C841] rounded-full shadow-md"></div>
            ...
            {blogs.map((post, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  bg-[#78C841]/10 text-[#78C841] px-3 py-1 rounded-full mb-3">
                    {post?.Category || post?.category || "General"}
                  </span>

                  <h3 className="text-lg font-semibold text-gray-900 leading-snug mb-3 
                  group-hover:text-[#78C841] transition">
